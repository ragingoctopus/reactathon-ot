...
const Restaurant = (props) => {
	...
	const choiceWinner = restaurant.winner ? <img style={{height: '75px'}} src='http://newhaven.tarrylodge.com/wp-content/uploads/sites/18/2015/08/Diners-Choice-740x380.png'/> : '';
	var stars = []
